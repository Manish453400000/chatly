...
const Clock:React.FC<{time:Time, onClickE:any, data: string}> = ({time, onClickE, data}) => {
  ...
  return (
    <div className=' relative w-[20rem] h-[20rem] overflow-hidden z-[1]'>
      ...
      <div className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[3]  overflow-hidden'>
        <div className="hour-circle w-[15rem] aspect-square rounded-full" ref={hourHand}>
          <div className="relative w-full h-full ">
